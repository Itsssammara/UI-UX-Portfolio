    ...
    <nav className="bg-black shadow-md px-6 py-4 fixed top-0 left-0 w-full z-50">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <li><a href="#case-studies" className="hover:text-pink-400 transition-colors">Case Studies</a></li>
      ...
      >
        ...
        <div className="flex flex-col space-y-6 px-6 pt-6">
          ...
          <a href="#projects" onClick={() => setMenuOpen(false)} className="hover:text-purple-400 transition">Case Studies</a>
