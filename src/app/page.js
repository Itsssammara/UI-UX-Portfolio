...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <main className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[#0d0b1f] via-[#1f1c2c] to-[#101010] text-white">
        ...
        <motion.div
          ...
          className="relative z-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl p-10 shadow-2xl max-w-xl text-center hover:scale-[1.02] transition-transform duration-300"
        >
          <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text">
            Hello, I’m Ammara!
          </h1>
          <p className="mt-4 text-lg sm:text-xl text-gray-300 tracking-wide">
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
            {[1, 2, 3].map((index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20 hover:border-purple-300 transition duration-300 hover:scale-[1.02] cursor-pointer flex flex-col items-start"
              >
